# nvim-treesitter-queries-wit

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-wit/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-wit/actions/workflows/validate.yml)

Neovim tree-sitter queries for **wit**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-wit",
...
- [ ] Changes are scoped to `wit` — do not include files for other languages
